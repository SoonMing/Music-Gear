...
<head>
  ...
  <title>MUSIC GEAR : Products Details</title>
  <!-- Bootstrap -->
...
<div class="container-fluid">
  <div class="row">
    <div class="col-xs-12 col-sm-5 col-sm-offset-1 col-md-4 col-md-offset-2 well well-sm text-center">
      ...
      <img src="products/<?php echo $readrow['fld_product_image'] ?>" width="100%" height="100%" class="img-responsive">
      <?php } ?>
    </div>
    <div class="col-xs-12 col-sm-5 col-md-4">
      ...
      <table class="table">
        ...
        <tr>
          ...
          <td><?php echo $readrow['fld_manufacture_date'] ?></td>
        </tr>
        <tr>
          <td><strong>Color</strong></td>
          <td><?php echo $readrow['fld_color'] ?></td>
        </tr>
        <tr>
