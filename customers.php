...
<head>
  ...
  <title>MUSICGEAR : Customers</title>
  ...
  <div class="container-fluid">
    ...
    <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
      ...
      <div class="form-group">
          <label for="pid" class="col-sm-3 control-label">Customer ID</label>
          <div class="col-sm-9">
      ...
      <div class="form-group">
          <label for="pid" class="col-sm-3 control-label">Customer Name</label>
          <div class="col-sm-9">
      ...
      <div class="form-group">
          ...
          <div class="col-sm-9">
          <input name="contact" type="text" class="form-control" id="contact" placeholder="Contact Number" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_customer_contact_number']; ?>" required >
        </div>
        </div> 
    ...
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      ...
      try {
        ...
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
         $stmt = $conn->prepare("SELECT * FROM tbl_customers_a161017_pt2 LIMIT $start_from, $per_page");
        $stmt->execute();
      ...
      <tr>
        ...
        <td><?php echo $readrow['fld_customer_contact_number']; ?></td>
        <td>
