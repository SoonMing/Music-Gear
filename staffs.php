  ...
  <div class="container-fluid">
    ...
    <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
      ...
      <div class="form-group">
          ...
          <div class="col-sm-9">
          <input name="contact" type="text" class="form-control" id="contact" placeholder="Contact Number" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_staff_contact_number']; ?>" required >
        </div>
        </div> 
         ...
         <div class="form-group">
          ...
          <div class="col-sm-9">
          <input name="password" type="text" class="form-control" id="password" placeholder="Password" value="<?php if(isset($_GET['edit'])) echo $editrow['password']; ?>" required >
        </div>
        </div> 
      ...
      $stmt = $conn->prepare("SELECT * FROM tbl_staffs_a161017_pt2 LIMIT $start_from, $per_page");
        $stmt->execute();
      ...
      <tr>
        ...
        <td><?php echo $readrow['fld_staff_contact_number']; ?></td>
