...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err)){
        ...
        if($stmt = $pdo->prepare("SELECT username, password FROM tbl_staffs_a161017_pt2 WHERE username = :username")){
...
<div>
        <p style="position: absolute; bottom: 0; right: 0; text-align:right;"><img src = logo.jpg></p>
    </div>
